...
if (inputFile) {
  (function () {
    ...
    var HappyTime = (function () {
      function HappyTime() {
        _classCallCheck(this, HappyTime);

        this.input = [];
      }

      _createClass(HappyTime, [{
        key: 'start',
        ...
        key: 'parseHours',
        value: function parseHours(string) {
          return parseInt(string.replace(',', '.') * 100, 10);
        }
      }, {
        key: 'stringHours',
        value: function stringHours(hours) {
          return (hours / 100).toString().replace('.', ',');
        }
      }, {
        key: 'roundHours',
        value: function roundHours(hours) {
        ...
        key: 'processCSV',
        value: function processCSV(input) {
          var _this3 = this;
        ...
        key: 'outputCSV',
        value: function outputCSV(output) {
